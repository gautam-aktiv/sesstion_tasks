...
class SalePurchaseWizard(models.TransientModel):
    ...
    is_dropship = fields.Boolean(
        string="Dropship", store=True, compute="_compute_is_dropship"
    )
    ...
    def action_confirm_from_wizard(self):
        ...
        updated_context = dict(self.env.context, open_wizard=False)
        ...
        if so_id:
            ...
            so_id.with_context(updated_context).action_confirm()
            ...
            po_id.with_context(updated_context).button_confirm()
